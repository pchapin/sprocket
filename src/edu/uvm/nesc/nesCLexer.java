// $ANTLR 3.4 nesC.g 2013-04-02 11:31:30
...
public class nesCLexer extends Lexer {
    ...
    public final void mCOMMENT1() throws RecognitionException {
        try {
            int _type = COMMENT1;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:998:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // nesC.g:998:10: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 



            // nesC.g:998:15: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mCOMMENT2() throws RecognitionException {
        try {
            int _type = COMMENT2;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:1001:5: ( '//' ( options {greedy=false; } : . )* ( '\\r' | '\\n' ) )
            // nesC.g:1001:10: '//' ( options {greedy=false; } : . )* ( '\\r' | '\\n' )
            {
            match("//"); 



            // nesC.g:1001:15: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mCOMMENT3() throws RecognitionException {
        try {
            int _type = COMMENT3;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:1006:5: ( '__extension__' )
            // nesC.g:1006:10: '__extension__'
            {
            match("__extension__"); 
    ...
    public final void mRAW_IDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:1009:5: ( ( '_' | 'a' .. 'z' | 'A' .. 'Z' ) ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
            // nesC.g:1009:10: ( '_' | 'a' .. 'z' | 'A' .. 'Z' ) ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            {
    ...
    public final void mCONSTANT() throws RecognitionException {
        try {
            int _type = CONSTANT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:1012:5: ( NUMBER )
            // nesC.g:1012:10: NUMBER
            {
            mNUMBER(); 
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:1015:5: ( '\"' ( options {greedy=false; } : . )* '\"' )
            // nesC.g:1015:10: '\"' ( options {greedy=false; } : . )* '\"'
            {
            match('\"'); 

            // nesC.g:1015:14: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mCHARACTER_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // nesC.g:1018:5: ( '\\'' ( options {greedy=false; } : . )* '\\'' )
            // nesC.g:1018:10: '\\'' ( options {greedy=false; } : . )* '\\''
            {
            match('\''); 

            // nesC.g:1018:15: ( options {greedy=false; } : . )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            // nesC.g:1032:5: ( DEC_NUMBER | HEX_NUMBER )
            int alt7=2;
    ...
    public final void mDEC_NUMBER() throws RecognitionException {
        try {
            // nesC.g:1036:5: ( ( DIGIT )+ ( NUMBER_SUFFIX )? )
            // nesC.g:1036:10: ( DIGIT )+ ( NUMBER_SUFFIX )?
            {
            // nesC.g:1036:10: ( DIGIT )+
            int cnt8=0;
            loop8:
            do {
                int alt8=2;
    ...
    public final void mHEX_NUMBER() throws RecognitionException {
        try {
            // nesC.g:1039:5: ( NUMBER_PREFIX ( HEX_DIGIT )+ ( NUMBER_SUFFIX )? )
            // nesC.g:1039:10: NUMBER_PREFIX ( HEX_DIGIT )+ ( NUMBER_SUFFIX )?
            {
            mNUMBER_PREFIX(); 


            // nesC.g:1039:24: ( HEX_DIGIT )+
            int cnt10=0;
            loop10:
            do {
                int alt10=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // nesC.g:1045:5: ( '0' .. '9' | 'a' | 'b' | 'c' | 'd' | 'e' | 'f' | 'A' | 'B' | 'C' | 'D' | 'E' | 'F' )
            // nesC.g:
            {
            if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'A' && input.LA(1) <= 'F')||(input.LA(1) >= 'a' && input.LA(1) <= 'f') ) {
                input.consume();
    ...
    public final void mNUMBER_SUFFIX() throws RecognitionException {
        try {
            // nesC.g:1051:5: ( ( 'l' | 'L' | 'u' | 'U' | 'lu' | 'ul' | 'LU' | 'UL' ) )
            // nesC.g:1051:10: ( 'l' | 'L' | 'u' | 'U' | 'lu' | 'ul' | 'LU' | 'UL' )
            {
            // nesC.g:1051:10: ( 'l' | 'L' | 'u' | 'U' | 'lu' | 'ul' | 'LU' | 'UL' )
            int alt12=8;
            switch ( input.LA(1) ) {
