...
The program in this directory demonstrates Sprocket's ability to do bidirectional communication.
It differs in this respect from the BlinkR sample (where communication is only one-way).
